...
np.random.seed(1)
# Load the data
data = pd.read_csv(r'C:\Users\maiko\Downloads\Youtube05-Shakira.csv')
...
new_comments = [
    "I hate this movie",
    "This movie was fantastic! I loved every moment.d",
...
my_data = pd.read_csv(r'C:\Users\maiko\Downloads\Youtube04-Eminem.csv')
